...
CHEF_CLIENT_COMMON_VERSION = "develop"
CHEF_CLIENT_COMMON = "https://github.com/dankilman/cosmo-plugin-chef-client-common/tarball/{0}".format(CHEF_CLIENT_COMMON_VERSION)
